      ...
      <div style={{ padding: '20px 16px', maxWidth: 600, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.75)', margin: '0 0 16px', lineHeight: 1.6 }}>
            Это бесценный вклад в ваш бизнес. Наша команда за 3–12 часов настроит всё так, что вы начнёте зарабатывать от 100 000 рублей в месяц. Большинство предпринимателей не знают, как это сделать правильно — Нейробаня знает.
          </p>
          <a
